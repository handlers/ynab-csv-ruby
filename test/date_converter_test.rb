...
class DateConverterTest < Minitest::Test
  def test_to_date_simple
    ...
    assert_equal YnabCsv::DateConverter.new(date_string).to_date, Date.new(2017, 8, 1)
  end
  ...
  def test_to_date_without_slashes
    ...
    assert_equal YnabCsv::DateConverter.new(date_string).to_date, Date.new(2012, 12)
  end
end
